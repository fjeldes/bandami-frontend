...
function PricingContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-blue-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 relative overflow-hidden">
      {/* Background glow effects — only in dark mode */}
      <div className="hidden dark:block absolute top-[-20%] left-[-10%] w-[60%] h-[60%] bg-blue-500/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="hidden dark:block absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] bg-violet-500/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="hidden dark:block absolute top-[40%] right-[20%] w-[30%] h-[30%] bg-emerald-500/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 py-16 md:py-24">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4 tracking-tight" style={{ fontFamily: "Inter, system-ui, sans-serif" }}>
        ...
        {isLoading ? (
          <div className="flex justify-center gap-6">
            {[1, 2].map((i) => (
              <div key={i} className="bg-white dark:bg-white/5 backdrop-blur-sm rounded-3xl border border-gray-200 dark:border-white/10 p-6 w-[380px] shadow-sm dark:shadow-none">
                <div className="animate-pulse space-y-4">
                  <div className="h-6 bg-gray-200 dark:bg-white/10 rounded-lg w-2/3" />
                  <div className="h-10 bg-gray-200 dark:bg-white/10 rounded-lg w-1/2" />
                  <div className="space-y-2">
                    {[1, 2, 3, 4].map((j) => (<div key={j} className="h-4 bg-gray-200 dark:bg-white/10 rounded w-full" />))}
                  </div>
                  <div className="h-12 bg-gray-200 dark:bg-white/10 rounded-full w-full" />
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 max-w-4xl mx-auto items-stretch justify-center">
            {visiblePlans.map((plan, idx) => (
              ...
              >
                {plan.slug === "free" && (
                  <div className="h-full bg-white dark:bg-white/5 backdrop-blur-md border border-gray-200 dark:border-white/10 rounded-3xl p-7 flex flex-col shadow-[0_8px_30px_rgba(0,0,0,0.06)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.12)] hover:border-gray-300 dark:hover:border-white/20 hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/5 dark:bg-blue-500/5 rounded-full blur-3xl -mr-10 -mt-10 group-hover:bg-blue-500/10 transition-all duration-500" />

                    {plan.badge && (
                      <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-gray-100 dark:bg-white/10 text-gray-500 dark:text-slate-300 text-[11px] font-bold uppercase tracking-wider mb-4 w-fit border border-gray-200 dark:border-white/5">
                        {plan.badge}
                      </div>
                    )}
                    ...
                    <div className="flex items-baseline gap-1 mb-6">
                      <span className="font-mono text-4xl font-extrabold text-gray-900 dark:text-white tracking-tight">$0</span>
                    </div>
                ...
                {plan.slug === "premium" && (
                  <>
                    {isPremium ? (
                      <div className="h-full bg-gradient-to-b from-white to-gray-50 dark:from-slate-800/80 dark:to-slate-900/80 backdrop-blur-md border border-emerald-200 dark:border-emerald-500/30 rounded-3xl p-7 flex flex-col shadow-[0_8px_40px_rgba(16,185,129,0.08)] dark:shadow-[0_8px_40px_rgba(16,185,129,0.1)] relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
                        <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-emerald-400 via-emerald-500 to-emerald-400" />
                        <div className="absolute top-0 right-0 w-40 h-40 bg-emerald-500/5 dark:bg-emerald-500/10 rounded-full blur-3xl -mr-14 -mt-14" />

                        <div className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/20 text-emerald-700 dark:text-emerald-400 text-[11px] font-bold uppercase tracking-wider mb-4 w-fit shadow-[0_0_20px_rgba(16,185,129,0.08)] dark:shadow-[0_0_20px_rgba(16,185,129,0.1)]">
                        ...
                        <div className="font-mono text-4xl font-extrabold text-emerald-600 dark:text-emerald-400 mb-2 tracking-tight">Active</div>
                        ...
                        <div className="w-full text-center py-3 rounded-xl bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/20 text-emerald-700 dark:text-emerald-400 text-[13px] font-semibold">
                          Your current plan
                        </div>
                      </div>
                    ) : (
                      <div className="h-full bg-gradient-to-b from-white to-gray-50 dark:from-slate-800/90 dark:to-slate-900/90 backdrop-blur-md border border-blue-200 dark:border-blue-500/30 rounded-3xl p-7 flex flex-col shadow-[0_8px_40px_rgba(59,130,246,0.08)] dark:shadow-[0_8px_40px_rgba(59,130,246,0.15)] relative overflow-hidden group hover:shadow-[0_8px_50px_rgba(59,130,246,0.12)] dark:hover:shadow-[0_8px_50px_rgba(59,130,246,0.25)] hover:-translate-y-1 transition-all duration-300">
                        ...
                        <div className="mb-2">
                          <div className="flex items-baseline gap-2">
                            <span className="font-mono text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-violet-600 dark:from-blue-400 dark:to-violet-400 tracking-tight">Free</span>
                        ...
                        <p className="text-[13px] text-gray-500 dark:text-slate-500 mb-6 pb-6 border-b border-gray-200 dark:border-white/5">
                          No charge during trial. Cancel anytime.
                        </p>

                        <ul className="space-y-3 mb-8 flex-1">
                          {plan.features.map((f, i) => {
                            const meta = featureMeta[f] || { icon: "check_circle", color: "text-blue-500 dark:text-blue-400" };
                            return (
                              <li key={i} className="flex items-start gap-2.5">
                                <span className={`material-symbols-outlined text-[18px] ${meta.color} mt-0.5 shrink-0`} style={{ fontVariationSettings: "'FILL' 1" }}>
                                  {meta.icon}
                                </span>
                                <span className="text-[14px] text-gray-700 dark:text-slate-300 font-medium">{f}</span>
                              </li>
                            );
                          })}
                        </ul>
...
export default function PricingPage() {
  return <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-950"><span className="material-symbols-outlined text-[40px] text-blue-500 dark:text-blue-400 animate-spin">progress_activity</span></div>}><PricingContent /></Suspense>;
}
