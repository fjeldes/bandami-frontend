  ...
  return (
    ...
    >
      ...
      <div className="p-5 pl-6 flex flex-col flex-grow">
        ...
        {/* Title */}
        <h3 className="text-base font-semibold dark:text-white mb-3 group-hover:dark:text-white transition-colors line-clamp-2 flex-grow">
        ...
        <div className="pt-4 border-t border-slate-100 dark:border-slate-800 mt-auto">
          {isTaken ? (
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-xs text-slate-500 dark:text-slate-400 font-medium">Best score</span>
              </div>
              <Link
            ...
            <Link
              href={`/writing/test?id=${question.id}`}
              className={`w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold text-white shadow-md transition-all duration-200 bg-slate-800 dark:bg-slate-700 hover:bg-slate-900 dark:hover:bg-slate-600 hover:shadow-lg active:scale-[0.98] hover:-translate-y-0.5`}
            >
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
              ...
              <button
                ...
                className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-200 ${
                  isActive
                    ...
                    : "bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 shadow-sm border border-slate-200 dark:border-slate-700"
                }`}
              >
                {tab.label}
              </button>
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-white dark:bg-slate-900 rounded-2xl shadow-sm">
            ...
            <p className="text-body-md text-slate-500 dark:text-slate-400">No tasks found for this filter.</p>
          </div>
        ) : (
