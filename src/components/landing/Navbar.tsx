    ...
    <nav className="flex justify-between items-center w-full px-gutter py-4 sticky top-0 z-50 bg-surface border-b border-surface-container-high">
      ...
      <div className="hidden md:flex items-center gap-8">
        ...
        <div className="relative" ref={resourcesRef}>
          ...
          {resourcesOpen && (
            <div className="absolute top-full left-0 mt-2 w-56 bg-surface-container-lowest rounded-2xl shadow-card hover:shadow-card-float transition-all duration-300 border border-transparent hover:border-outline-variant/50 z-50 overflow-hidden">
              <Link
