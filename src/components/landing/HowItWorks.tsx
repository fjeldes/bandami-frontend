    ...
    <section className="py-section-gap px-margin-mobile md:px-gutter bg-surface" id="how-it-works">
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
          ...
          {steps.map((step) => (
            <div key={step.icon} className="relative z-10 flex flex-col items-center text-center group">
              <div className="w-24 h-24 rounded-full bg-surface-container-lowest border border-outline-variant/50 ghost-shadow flex items-center justify-center mb-8 group-hover:border-primary/30 transition-colors duration-300">
