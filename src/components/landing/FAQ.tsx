const faqs = [
  ...
  { q: "What is the Exam Week Pass?", a: "The Exam Week Pass gives you 7 days of full Premium access for a one-time payment of $2.99. It's perfect if your exam is coming up and you want to practice intensively without a monthly subscription. After 7 days, you can upgrade to Premium ($14.99/month) or continue with Free." },
