...
const faqs = [
  ...
  { q: "What do I get on the Free plan?", a: "The Free plan gives you instant band scores, basic feedback, and identification of your main strengths and weaknesses. You get full access to Writing and Speaking Part 1. To unlock Speaking Part 2 & 3, grammar corrections, and detailed feedback, try Pro ($9.99/month — 3-day free trial)." },
  { q: "How does the Pro trial work?", a: "Your first 3 days are free. You get full access to everything — unlimited practice, detailed analysis, personalized recommendations, study plans, and all exam modules. After 3 days, it's $9.99/month + tax. Cancel anytime. No charge if you cancel during the trial." },
