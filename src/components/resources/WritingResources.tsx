...
import { PenTool, ArrowRight, BookOpen, Lightbulb } from "lucide-react";
...
export default function WritingResources({ basePath = "/resources" }: { basePath?: string }) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {category.tips.map((tip) => {
          ...
          return (
            <Link
              key={tip.slug}
              href={`${basePath}/writing/${tip.slug}`}
